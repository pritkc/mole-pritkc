...
void Jac::Jacobian(const u16 k, const mat &Xin, const mat &Yin)
{
    // Returns:
...
void Jac::Jacobian(const u16 k, const cube &Xin, const cube &Yin, const cube &Zin)
{
    // Returns:
    //                J : Determinant of the Jacobian (XeYn - XnYe)
    //               Xe : dx/de metric
    ...
    Jacob = Xe%(Yn%Zc-Yc%Zn)-Ye%(Xn%Zc-Xc%Zn)+Ze%(Xn%Yc-Xc%Yn);
